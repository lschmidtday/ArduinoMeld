...
const contractABI = require("../artifacts/contracts/Arduinomeld.sol/Arduinomeld.json").abi;

program
    .name("arduinomeld-cli")
    .description("CLI tool for Arduinomeld smart contract")
    .version("1.0.0");
